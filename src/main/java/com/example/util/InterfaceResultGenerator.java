...
import com.example.publiuc.RestResult;
import com.example.publiuc.ResultCode;
import org.springframework.stereotype.Component;

/**
 * @author:wangxiaorui
 * @create 2019年12月19日18:55:07
 * 工厂模式
 * 外部接口信息生成工具
 * 。@Component 添加到Spring组件中
 */
@Component
public class InterfaceResultGenerator extends RestResult {
